		...
		<div class="main-content">
			...
			<div class="floatLeft">
				<ul>
					...
					<!-- 度假酒店 -->
					<li class="hotel" :class="{'actives' : $route.name == ''}" @mouseover="overHover('a')" @mouseout="outHover('')">
					...
					<!-- 新闻中心 -->
					<li class="news" :class="{'actives' : $route.path == '/news' || $route.path == '/newList' || $route.path == '/noticeList' || $route.path == '/newDetail' || $route.path == '/noticeDetail'}" @mouseover="overHover('news')" @mouseout="outHover('')">
					...
					<!-- 优惠活动 -->	
					<li class="active" :class="{'actives' : $route.path == '/specialOffier' || $route.path == '/events' || $route.path == '/EventsDetail'}" @mouseover="overHover('specialOffier')" @mouseout="outHover('')">
					...
					<!-- 动物百科 -->
					<li class="animal" :class="{'actives' : $route.name == 'Animal'}" @mouseover="overHover('Animal')" @mouseout="outHover('')">
