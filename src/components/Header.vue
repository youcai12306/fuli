    ...
    <div class="main-content">
      ...
      <div class="floatLeft">
        <ul>
          ...
          <!-- 主题乐园 -->
          <li
            @mouseover="showNavList(1),height='97px'"
            @mouseout="hiddenNavList(1),height='0px'"
            class="theme"
          ...
          >
            <template
              v-if="$route.path == '/news' || $route.path == '/newList' || $route.path == '/noticeList' || $route.path == '/newDetail' || $route.path == '/noticeDetail'"
            >
          ...
          >
            <template
              v-if="$route.path == '/specialOffier' || $route.path == '/events' || $route.path == '/EventsDetail'"
            >
